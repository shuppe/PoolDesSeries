...
/**
 * Function to output the fullname of someone from all CAPS to correct case (ex: MAXIME GIRARD -> Maxime Girard).
 * @param string $string User's full name
...
/**
 * A function to format the bytes of a file, as a natural looking string. This version handes it via 1024 based logic.
 * @param int $bytes You provide the Bytes size of a file.
 ...
 * @param string $french French word/sentence.
 * @param boolean $hscc HTML special character code on or off.
...
function remove_french_accent($french, $hscc = false)
{
	if($hscc)
	{
		...
		'È'=>'&Egrave;', 'É'=>'&Eacute;', 'Ê'=>'&Ecirc;', 'Ë'=>'&Euml;', 'è'=>'&egrave;', 'é'=>'&eacute;', 'ê'=>'&ecirc;', 'ë'=>'&euml;',
		'Ì'=>'&Igrave;', 'Í'=>'&Iacute;', 'Î'=>'&Icirc;', 'Ï'=>'&Iuml;', 'ì'=>'&igrave;', 'í'=>'&iacute;', 'î'=>'&icirc;', 'ï'=>'&iuml;',
		'Ò'=>'&Ograve;', 'Ó'=>'&Oacute;', 'Ô'=>'&Ocirc;', 'Ö'=>'&Ouml;', 'ò'=>'&ograve;', 'ó'=>'&oacute;', 'ô'=>'&ocirc;', 'ö'=>'&ouml;',
		'Ù'=>'&Ugrave;', 'Ú'=>'&Uacute;', 'Û'=>'&Ucirc;', 'Ü'=>'&Uuml;', 'ù'=>'&ugrave;', 'ú'=>'&uacute;', 'û'=>'&ucirc;', 'û'=>'&uuml;',
		'Ç'=>'&Ccedil;', 'ç'=>'&ccedil;',   
		'Ãª'=>'&ecirc;', 'Ã¨'=>'&egrave;', 'Ã¨'=>'&egrave;', 'Ã©'=>'&eacute;', 'Ã‰'=>'&Eacute;', 'ÃŠ'=>'&Ecirc;', 'Ãˆ'=>'&Egrave;', 
		'Ã™'=>'&Ugrave;', 'Ã©'=>'&eacute;', 'Ã¢'=>'&acirc;', 'Ã§'=>'&ccedil;', 'Ã'=>'&agrave;', 'Ãª'=>'&ecirc;', 'â€™'=>'\''
		);
		return strtr($french, $html_code);
	}
	else
	{
		$search = explode(",","Ç,ç,¿,æ,œ,á,É,é,í,ó,ú,À,à,È,è,Ì,ì,Ò,ò,Ù,ù,Ä,ä,Ë,ë,Ï,ï,Ö,ö,Ü,ü,ÿ,Â,â,Ê,ê,Î,î,Ô,ô,Û,û,å,e,i,ø,€™");
 ...
 * @param array $array The array you want a readable display of.
 ...
 * @param array $value The array you want a readable display of.
 * @return string A 'human readable' display of your array.
 */
